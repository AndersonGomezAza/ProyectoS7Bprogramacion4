...
CREATE TABLE Pagos (
    rc_pagos INT PRIMARY KEY NOT NULL IDENTITY(1,1),
    factura_pagos INT NOT NULL,
    fecha_pagos DATE NOT NULL,
    fecha_abono_canon_pagos DATE NOT NULL,
    abono_administracion_pagos DECIMAL(14,4) NOT NULL,
    interes_pagos DECIMAL(14,4) NOT NULL,
    tasa_interes_pagos DECIMAL(14,4) NOT NULL,
)
...
CREATE TABLE ArregloLocativo (
    ...
    estado_arreglo VARCHAR(30) NOT NULL,
...
CREATE TABLE ContratoArriendo (
    ...
    valor_canon_contrato DECIMAL(14,4) NOT NULL,
    valor_administracion_contrato DECIMAL(14,4) NOT NULL,
...
CREATE TABLE Inmueble (
   ...
   area_privada_inmueble DECIMAL(14,4) NOT NULL,
   area_construida_inmueble DECIMAL(14,4) NOT NULL,
...
-- CREACION DE CONSTRAINS O RESTRICCIONES
  -- LLAVES FORANEAS TABLAS DEBILES
	ALTER TABLE ContratoArriendo ADD CONSTRAINT pk_contrato_arrendatario FOREIGN KEY (cedula_arrendatario_contrato) REFERENCES Arrendatario(cedula_arrendatario);
	ALTER TABLE ContratoArriendo ADD CONSTRAINT pk_contrato_pagos FOREIGN KEY (rc_pagos_contrato) REFERENCES Pagos (rc_pagos);
	ALTER TABLE Inmueble ADD CONSTRAINT pk_inmueble_arreglo FOREIGN KEY (id_locativa_inmueble) REFERENCES ArregloLocativo (id_locativa_arreglo);
	ALTER TABLE Inmueble ADD CONSTRAINT pk_inmueble_propietario FOREIGN KEY (cedula_propietario_inmueble) REFERENCES Propietario (cedula_propietario);
	ALTER TABLE Inmueble ADD CONSTRAINT pk_inmueble_proyecto FOREIGN KEY (matricula_inmobiliaria_proyecto_inmueble) REFERENCES Proyecto (matricula_inmobiliaria_proyecto);
  
	-- LLAVES FORANEAS TABLAS TRANSICION
	ALTER TABLE ContratoInmueble ADD CONSTRAINT pk_contrato_inmueble_contrato_arriendo FOREIGN KEY (id_contrato) REFERENCES ContratoArriendo (id_contrato);
	ALTER TABLE ContratoInmueble ADD CONSTRAINT pk_contrato_inmueble_inmueble FOREIGN KEY (matricula_inmobiliaria_inmueble) REFERENCES Inmueble (matricula_inmobiliaria_inmueble);
